...
# %%due to a little error in the pretest (80 instead of 90 for the true delta perfomance), 
#we define another model for the pre-test data
def model_Pretest(DSTExperience, TechEngagement, RiskPref, Age, Farmsize, AdvisorExperience, #exogenous cahracteristics
          True_DeltaPerformance_Q0, True_DeltaPerformance_Q1, True_DeltaPerformance_Q2,#treatment
          AIA_1=None, AIA_2=None, AIA_3=None, AIA_4=None, AIA_5=None, AIA_6=None, AIA_7=None, AIA_8=None, AIA_9=None, AIA_10=None, AIA_11=None, AIA_12=None, AIA_13=None, AIA_14=None, AIA_15=None, AIA_16=None, #outcome of interest (AI Anxiety)
          SI_1=None, SI_2=None, 
          PE_1=None, PE_2=None, PE_3=None, PE_4=None,
          EE_1=None, EE_2=None, EE_3=None,
          BI_1=None, BI_2=None, BI_3=None, #outcome of interest (Behavioral Intention)
          Delta_WTP_Q0_relTo80=None, #outcome of interest (Delta WTP_Q0)
          Delta_WTP_Q1_relTo80=None, #outcome of interest (Delta WTP_Q1)
          Delta_WTP_Q2_relTo80=None, #outcome of interest (Delta WTP_Q2)
           ):
   ...
   #AIAnxiety
    ...
    beta_AA = numpyro.sample('beta_AA', dist.Normal(0, 0.5)) # our parameter of interest = Algorithm Aversion
    beta_deltaTrue = numpyro.sample('beta_deltaTrue', dist.Normal(0, 0.5))  # Coef determining how percentage delta performance is mapped in WTP
    Delta_WTP_Q0_relTo80 = numpyro.sample("Delta_WTP_Q0_relTo80", dist.Normal(beta_AA*LatentAIAnxiety+beta_deltaTrue*True_DeltaPerformance_Q0,0.2), obs=Delta_WTP_Q0_relTo80) #set SD to 0.3 to ensure it only ranges from -1 to 1
    Delta_WTP_Q1_relTo80 = numpyro.sample("Delta_WTP_Q1_relTo80", dist.Normal(beta_AA*LatentAIAnxiety+beta_deltaTrue*True_DeltaPerformance_Q1,0.2), obs=Delta_WTP_Q1_relTo80)
    Delta_WTP_Q2_relTo80 = numpyro.sample("Delta_WTP_Q2_relTo80", dist.Normal(beta_AA*LatentAIAnxiety+beta_deltaTrue*True_DeltaPerformance_Q2,0.2), obs=Delta_WTP_Q2_relTo80)
...
#%%for preregistration: only Algorithm Aversion betas
